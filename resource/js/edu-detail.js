    ...
    if (modal) {
      ...
      const openModal = (youtubeUrl) => {
        ...
        if (youtubeUrl) {
          ...
          modal.insertBefore(modalIframe, modalClose);
        } else {
          modalMessage = document.createElement('p');
          modalMessage.className = 'modal-message';
          modalMessage.textContent = '영상을 준비 중입니다.';
          modal.insertBefore(modalMessage, modalClose);
        }
...
document.querySelectorAll('.cta-primary[href="#"], .branch-link[href="#"]').forEach((el) => {
