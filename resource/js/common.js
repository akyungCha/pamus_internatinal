...
(function () {
  ...
  function createStar() {
    ...
    return {
      ...
      speed:    isDim ? rand(0.003, 0.008) : isBright ? rand(0.01, 0.02) : rand(0.005, 0.012),
      minAlpha: isDim ? 0.12 : isBright ? 0.45 : 0.25,
      maxAlpha: isDim ? 0.45 : isBright ? 0.85 : 0.65,
      hue:      hue,
  ...
  function spawnFlare(s) {
    ...
    flares.push({
      x: s.x, y: s.y,
      vx: Math.cos(angle) * rand(1.2, 2.6),
      vy: Math.sin(angle) * rand(1.2, 2.6),
      len: rand(30, 80),
      life: 1.0,
